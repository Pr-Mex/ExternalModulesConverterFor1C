...
Иначе
	...
	Если АргументыКоманднойСтроки.Количество() = 2 Тогда
		...
		МассивМасок.Добавить("*.erf");
		МассивКаталоговОткуда = Новый Массив;
		МассивКаталоговОткуда.Добавить(АргументыКоманднойСтроки[0]);
		ПереместитьФайлыВКаталог(АргументыКоманднойСтроки[1], МассивКаталоговОткуда, МассивМасок);
	КонецЕсли;
